...
const TechnologiesContainer = () => {
  ...
  const technologies = [
    {
      id: "java",
      name: t("tech.java.name"),
      icon: <DiJava />,
      description: t("tech.java.desc"),
    },
    {
      id: "spring",
      name: t("tech.spring.name"),
      icon: <SiSpring />,
      description: t("tech.spring.desc"),
    },
    {
      id: "docker",
      name: t("tech.docker.name"),
      icon: <SiDocker />,
      description: t("tech.docker.desc"),
    },
    {
      id: "linux",
      name: t("tech.linux.name"),
      icon: <DiLinux />,
      description: t("tech.linux.desc"),
    },
    {
      id: "psql",
      name: t("tech.psql.name"),
      icon: <SiPostgresql />,
      description: t("tech.psql.desc"),
    },
    {
      id: "mongo",
      name: t("tech.mongo.name"),
      icon: <SiMongodb />,
      description: t("tech.mongo.desc"),
    },
  ];
            ...
            >
              <div className="flex gap-6">
                ...
                <div className="flex-1">
                  <h3 className="tech-card-title font-bold text-lg mb-2">
                    {tech.name}
                  </h3>
                  <p className="tech-card-text text-sm leading-relaxed">
                    {tech.description}
                  </p>
                </div>
              </div>
