...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  "pt-BR": {
    ...
    "tech.java.name": "Java",
    "tech.java.desc":
      "Desenvolvo em Java há 5 anos. Experiência sólida no desenvolvimento de API's",
    "tech.spring.name": "SpringBoot",
    "tech.spring.desc":
      "Utilizo SpringBoot a 5 anos, para desenvolvimento de REST e GraphQL API's",
    "tech.docker.name": "Docker",
    "tech.docker.desc":
      "Utilizo Docker para ambientes de CI/CD para uma melhor qualidade no desenvolvimento",
    "tech.linux.name": "Linux",
    "tech.linux.desc":
      "Linux é meu sistema operacional principal e estou sempre me aprimorando",
    "tech.psql.name": "PostgreSQL",
    "tech.psql.desc":
      "Utilizo o PostgreSQL como uma opção SQL, mas conheço diversas opções SQL",
    "tech.mongo.name": "MongoDB",
    "tech.mongo.desc":
      "Bancos NoSQL, o que mais utilizei foi MongoDB. Mas também utilizo outras opções NoSQL",
  ...
  "en-US": {
    ...
    "tech.java.name": "Java",
    "tech.java.desc":
      "I've been developing in Java for 5 years. Solid experience in API development",
    "tech.spring.name": "SpringBoot",
    "tech.spring.desc":
      "I've been using SpringBoot for 5 years for REST and GraphQL API development",
    "tech.docker.name": "Docker",
    "tech.docker.desc":
      "I use Docker for CI/CD environments for better development quality",
    "tech.linux.name": "Linux",
    "tech.linux.desc":
      "Linux is my main operating system and I'm always improving",
    "tech.psql.name": "PostgreSQL",
    "tech.psql.desc":
      "I use PostgreSQL as an SQL option, but I know several SQL options",
    "tech.mongo.name": "MongoDB",
    "tech.mongo.desc":
      "NoSQL databases, the one I used most was MongoDB. But I also use other NoSQL options",
    "projects.title": "Projects",
    "projects.text":
      "Below, I share some of my personal projects that I developed. Most of them are backend-focused, but in some cases, I also integrated a frontend to improve the user browsing experience.",
